...
<section class="hero hero-dual">
  <div class="container">
    ...
    <h1>Оберіть правильну книгу DTZ або ÖIF і почніть підготовку на реальних форматах іспиту.</h1>
    ...
    <div class="hero-book-grid">
      <article class="book-panel book-panel-accent">
        ...
        <p>Цей розділ для тих, хто складає Deutsch-Test für Zuwanderer у Німеччині та хоче практичну підготовку саме до усної частини та письмового завдання.</p>
        <ul class="check-list">
      ...
      <article class="book-panel">
        ...
        <p>Цей розділ для тих, кому потрібна австрійсько-орієнтована підготовка до ÖIF B1 Integrationprüfung з реалістичною усною практикою та чіткою підтримкою для письма.</p>
        <ul class="check-list">
