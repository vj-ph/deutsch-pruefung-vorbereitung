...
function purchaseOptions(paperbackUrl, kindleUrl, paperbackPrice, kindlePrice) {
  return [
    {
      ...
      priceDisplay: euro(paperbackPrice),
      url: paperbackUrl,
  ...
  return Object.fromEntries(
    locales.map((locale) => {
      ...
      return [locale, {
        ...
        description: localeCopy.description[sectionKey](examTitle),
        summary: localeCopy.summary[sectionKey](examTitle, countryLabel),
        features: localeCopy.features[sectionKey](examTitle, countryLabel),
        fit: localeCopy.fit[sectionKey],
        recommendation: localeCopy.recommendation[sectionKey]
      }];
    })
  );
}
...
const exams = {
  "dtz-a2": {
    ...
    navLabel: "DTZ A2",
    anchor: "dtz-a2",
    description: "DTZ A2 books for Germany with separate speaking and writing practice plus one combined edition.",
    booksIntro: "Compare the DTZ A2 speaking, writing, and combined books and open the free sample PDFs where available.",
    localizedBooksIntro: buildLocalizedBooksIntro("DTZ A2"),
    books: ["dtz-a2-speaking", "dtz-a2-writing", "dtz-a2-combined"]
  },
  "oeif-a2": {
    key: "oeif-a2",
    examCode: "oeif",
    ...
    navLabel: "ÖIF A2",
    anchor: "oeif-a2",
    description: "ÖIF A2 books for Austria with separate speaking and writing practice plus one combined edition.",
    booksIntro: "Compare the ÖIF A2 speaking, writing, and combined books and open the free sample PDFs where available.",
    localizedBooksIntro: buildLocalizedBooksIntro("ÖIF A2"),
    books: ["oeif-a2-speaking", "oeif-a2-writing", "oeif-a2-combined"]
  },
  "fide-a2": {
    key: "fide-a2",
    examCode: "fide",
    ...
    navLabel: "fide A2",
    anchor: "fide-a2",
    description: "fide A2 books for Switzerland with separate speaking and writing practice plus one combined edition.",
    booksIntro: "Compare the fide A2 speaking, writing, and combined books and open the free sample PDFs where available.",
    localizedBooksIntro: buildLocalizedBooksIntro("fide A2"),
    books: ["fide-a2-speaking", "fide-a2-writing", "fide-a2-combined"]
  },
  "dtz-b1": {
    key: "dtz-b1",
    examCode: "dtz",
    ...
    navLabel: "DTZ B1",
    anchor: "dtz-b1",
    description: "DTZ B1 books for Germany with separate speaking and writing practice plus one combined edition.",
    booksIntro: "Compare the DTZ B1 speaking, writing, and combined books and open the free sample PDFs where available.",
    localizedBooksIntro: buildLocalizedBooksIntro("DTZ B1"),
    books: ["dtz-b1-speaking", "dtz-b1-writing", "dtz-b1-combined"]
  },
  "oeif-b1": {
    key: "oeif-b1",
    examCode: "oeif",
    ...
    navLabel: "ÖIF B1",
    anchor: "oeif-b1",
    description: "ÖIF B1 books for Austria with separate speaking and writing practice plus one combined edition.",
    booksIntro: "Compare the ÖIF B1 speaking, writing, and combined books and open the free sample PDFs where available.",
    localizedBooksIntro: buildLocalizedBooksIntro("ÖIF B1"),
    books: ["oeif-b1-speaking", "oeif-b1-writing", "oeif-b1-combined"]
  },
  "fide-b1": {
    key: "fide-b1",
    examCode: "fide",
    ...
    navLabel: "fide B1",
    anchor: "fide-b1",
    description: "fide B1 books for Switzerland with separate speaking and writing practice plus one combined edition.",
    booksIntro: "Compare the fide B1 speaking, writing, and combined books and open the free sample PDFs where available.",
    localizedBooksIntro: buildLocalizedBooksIntro("fide B1"),
    books: ["fide-b1-speaking", "fide-b1-writing", "fide-b1-combined"]
  }
};
...
module.exports = {
  title: "Deutsch Kompass A2 & B1 Books",
  description: "Separate A2 and B1 book pages for DTZ, ÖIF, and fide speaking, writing, combined books, and free sample PDFs.",
  ...
  bookOrder,
  examOrder: ["dtz-a2", "oeif-a2", "fide-a2", "dtz-b1", "oeif-b1", "fide-b1"],
  levelOrder,
  levels: {
    a2: {
      key: "a2",
